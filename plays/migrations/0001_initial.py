    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotifyCode', models.CharField(blank=True, choices=[('lion_king', 'The Lion King Soundtrack'), ('annie', 'Annie Soundtrack'), ('phantom_of_the_opera', 'Phantom of the Opera Soundtrack'), ('sound_of_music', 'Sound of Music Soundtrack'), ('book_of_mormon', 'Book of Mormon Soundtrack'), ('hamilton', 'Hamilton Soundtrack'), ('wicked', 'Wicked Soundtrack'), ('les_miserables', 'Les Miserables Soundtrack'), ('mamma_mia', 'Mamma Mia Soundtrack'), ('dear_evan_hansen', 'Dear Evan Hansen Soundtrack')], max_length=50, null=True)),
