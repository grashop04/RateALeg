    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotifyCode', models.CharField(blank=True, choices=[('lion_king', 'The Lion King'), ('annie', 'Annie, The Musical'), ('phantom_of_the_opera', 'The Phantom of the Opera'), ('sound_of_music', 'The Sound of Music'), ('book_of_mormon', 'The Book of Mormon'), ('hamilton', 'Hamilton'), ('wicked', 'Wicked Soundtrack'), ('les_miserables', 'Les Misérables'), ('mamma_mia', 'Mamma Mia!'), ('dear_evan_hansen', 'Dear Evan Hansen')], max_length=50, null=True)),
