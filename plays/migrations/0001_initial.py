# Generated by Django 2.2.28 on 2025-03-27 16:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotifyCode', models.CharField(choices=[('lion_king', 'The Lion King Soundtrack'), ('annie', 'Annie Soundtrack'), ('phantom_of_the_opera', 'Phantom of the Opera Soundtrack'), ('sound_of_music', 'Sound of Music Soundtrack'), ('book_of_mormon', 'Book of Mormon Soundtrack'), ('hamilton', 'Hamilton Soundtrack'), ('wicked', 'Wicked Soundtrack'), ('les_miserables', 'Les Miserables Soundtrack'), ('mamma_mia', 'Mamma Mia Soundtrack'), ('dear_evan_hansen', 'Dear Evan Hansen Soundtrack')], default='annie', max_length=50)),
